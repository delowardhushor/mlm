        ...
        <div class="container-fluid">
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        $result500 = $db->select("SELECT * FROM mlm_comhis WHERE member > '$userid' AND com_by = 'Board' AND amount = 500 ");
                        if($result500){
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        $result1000 = $db->select("SELECT * FROM mlm_comhis WHERE member > '$userid' AND com_by = 'Board' AND amount = 1000 ");
                        if($result1000){
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        $result2000 = $db->select("SELECT * FROM mlm_comhis WHERE member > '$userid' AND com_by = 'Board' AND amount = 2000 ");
                        if($result2000){
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        $result5000 = $db->select("SELECT * FROM mlm_comhis WHERE member > '$userid' AND com_by = 'Board' AND amount = 5000 ");
                        if($result5000){
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">List of Member got 10000</h4>
                  <p class="card-category"></p>
                </div>
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        $result10000 = $db->select("SELECT * FROM mlm_comhis WHERE member > '$userid' AND com_by = 'Board' AND amount = 10000 ");
                        if($result10000){
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">List of Member got 20000</h4>
                  <p class="card-category"></p>
                </div>
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        $result20000 = $db->select("SELECT * FROM mlm_comhis WHERE member > '$userid' AND com_by = 'Board' AND amount = 20000 ");
                        if($result20000){
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        $result50000 = $db->select("SELECT * FROM mlm_comhis WHERE member > '$userid' AND com_by = 'Board' AND amount = 50000 ");
                        if($result50000){
